...
session_start();
	...
	public function export_dispatch()
	{
		if($this->session->userdata('user_role') == 'admin')  
	   {
		   $this->load->view('admin/export_dispatch');
	   }
	    else  
	   {  
			redirect(base_url() . 'index.php/login/index');  
	...
	public function delay_report()
	{
		if($this->session->userdata('user_role') == 'admin')  
	   {
		   $result['data'] = $this->home->get_delay_report();
		   $this->load->view('admin/delay_report', $result);
	   }
	    else  
	   {  
			redirect(base_url() . 'index.php/login/index');  
	...
	/******************* PlanVsDispatch report **********************/
	public function planVsDispatch()
	{
		if($this->session->userdata('user_role') == 'admin')  
	   {
		   $result['data'] = $this->home->get_planVsDispatch_report();
		   $this->load->view('admin/planvsdispatch-report', $result);
	   }
	    else  
	   {  
			redirect(base_url() . 'index.php/login/index');  
 ...
 //     public function delay_report()
	...
	// 	if($this->session->userdata('user_role') == 'admin')  
	//    {
	// 	   $this->load->view('admin/delay_report');
	//    }
	//     else  
	//    {  
	// 		redirect(base_url() . 'index.php/login/index');  
