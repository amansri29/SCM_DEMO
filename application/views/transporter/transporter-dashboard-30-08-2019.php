                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $value) {
                                                ...
                                                $order_status = $value['order_status']; {
                                                    if (array_fill(0, count($quantity), '0') === array_values($quantity)) { } else {
                                                        ?>
                                                        <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            if ($order_status == 'Pending') {
                                                                                ...
                                                                                <?php if ($value1['order_status'] == 'Pending' && $value1['ocs_status'] == 'Bid') {
                                                                                    if ((strtotime($current_date) >= strtotime($bid_newdate)) or $result) { } else { ?>
                        ...
                        if (obj) {
                            ...
                            $(obj).each(function() {
                                ...
                                if (this.status == 'disabled') {
                                    ...
                                    }).text(this.registration_no + '   TC(' + this.tcapacity + '),' + '   RC(' + this.rcapacity + ')');
