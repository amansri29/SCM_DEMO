                      ...
                      <section class="panel">
                          <header class="panel-heading">
						   ...
						   <div class="panel-body">
                               <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data"  action="<?php echo base_url();?>index.php/admin/save_scanner_user">
								<div class="col-lg-6">
									...
									<div class="col-lg-8">
                                         <select class="js-example-basic-single vehicle" multiple id='transporter' required name='user_type[]'>
											<option disabled >Select User Type</option>
											<option value='Gate User' >Gate User</option>
											<option value='Weighbridge User' >Weighbridge User</option>
											<option value='Loading User' >Loading User</option>
