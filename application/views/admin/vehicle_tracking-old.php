...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content1">
	...
	<?php        
				...
				$getval=$_REQUEST['id'];
				$getvalarray = explode("_", $getval);
				$id = $getvalarray[0];
				$order_id = $getvalarray[1];
				$this->db->select('*');
				...
				foreach($sql  as  $get)
				{
					...
					if(!empty($shipping_address)){
						...
						$formattedAddr = str_replace(' ','+',$ship_to_city);
