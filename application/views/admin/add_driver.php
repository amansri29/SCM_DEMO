                      ...
                      <section class="panel">
                          <header class="panel-heading">
						   ...
						   <div class="panel-body">
                             <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data"  action="<?php echo base_url();?>index.php/admin/save_driver">
								<div class="col-lg-6">
                                      ...
                                      <div class="col-lg-8">
                                         <select class="js-example-basic-single vehicle" id='transporter' required name='transporter_id'>
											...
											?>
													...
													<option value="<?php echo $value['user_id']?>"><?php echo $value['name']." ".$value['company'] ?></option>
											<?php
												}
											?>																
										</select>
									...
									<div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                          <input type="text" class="form-control" id="mobile" name="mobile" required placeholder="Enter Number">
                                      </div>
									</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                          <input type="text" class="form-control" id="license_no" name="license_no" required placeholder="Enter License No.">
                                      </div>
									</div>
									<div class="form-group">
                                      <label for="city" class="col-lg-3 col-sm-2 control-label">Valid Upto</label>
                                      <div class="col-lg-8">
                                          <input type="text" class="form-control form-control-inline input-medium default-date-picker" name="valid_upto" required id="date" placeholder="Enter Date">
                                      </div>
									</div>
